...
(function setupPWA(){
  ...
  if('serviceWorker' in navigator){
    window.addEventListener('load',()=>navigator.serviceWorker.register('./service-worker.js?v=11.68', {updateViaCache: 'none'}).catch(err=>console.warn('PWA service worker:',err)));
  }
