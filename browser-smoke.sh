...
chromium --headless --no-sandbox --disable-gpu --virtual-time-budget=6000 --dump-dom "http://127.0.0.1:${PORT}/tests/browser-interactive.html" >"$TMP/interactive.html" 2>"$TMP/interactive.err"
